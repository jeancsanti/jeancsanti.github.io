...
<head>
    ...
    <meta name="author" content="Jean Carlos Santi" />
    <meta name="description" content="Portifólio de trabalhos realizados e formação de Jean Carlos Santi" />
    <!-- Styles -->
        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/profile.jpeg" alt="Jean Carlos Santi">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Jean Carlos Santi</h4>
                        <div class="status">Desenvolvedor WEB</div>
                        <ul class="header__social">
                            <li>
                                <a href="https://www.linkedin.com/in/jean-carlos-santi-67a77638/">
                                    <i class="font-icon icon-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/jeancsanti">
                ...
                <div class="header__right">
                    <ul class="header__contact">
                        <li>
                            ...
                            jeansanti.comercial@contato.com.br
                        </li>
                        <li>
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Jean Carlos Santi</footer>
                </div>
            </div>
        </div>
    </main>
